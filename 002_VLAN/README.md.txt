...
Abbiamo creato 2 file diversi perchè in uno usiamo il PORT ACCCES quindi si utilizzano 2 cavi(1 per ogni VALN) per collegare i 2 switch mentre nel
TRUNK aìserve solo un cavo perchè attraverso quel cavo tutte le VLAN possono comunicarci attraverso.
